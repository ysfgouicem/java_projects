/*
Using https://projecteuler.net/problem=22 , a 46K text file containing over five-thousand first names, begin by sorting it into alphabetical order.
...
public class Namescore {
    public static void main(String [] args){
        ...
        for (int i = 0; i < names.length; i++){
            totalscore+=calculateScore(names[i].toUpperCase())*(i+1);
        }
        System.out.println("the total score of all names is : "+totalscore);
    }
    ...
    public static   String[] names = {"MARY", "PATRICIA", "LINDA", "BARBARA", "ELIZABETH", "JENNIFER", "MARIA", "SUSAN", "MARGARET", "DOROTHY",
